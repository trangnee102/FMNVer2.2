...
import "../../Dashboard/DashboardPage.css"; // Import CSS layout chung của Dashboard
...
const CreateExamManualPage = ({ onNavigate }) => {
  ...
  return (
    <div className="dashboard-layout">
      {/* 1. Gọi Sidebar bên trái và cho nó biết đang ở luồng "create" */}
      <Sidebar currentView="create" onNavigate={onNavigate} />

      {/* 2. Bọc toàn bộ nội dung trong dashboard-content để có thanh cuộn riêng */}
      <main className="dashboard-content scrollable-content">
